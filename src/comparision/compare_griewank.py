...
-----
    ...
    python -m comparision.compare_griewank --save --output-dir outputs/run_01
    python -m comparision.compare_griewank --save --save-json
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Algorithm comparison on Griewank (2-D)"
    )
    ...
    save_path = (
        make_output_path("compare_griewank.png", args.output_dir) if args.save else None
    )
    ...
    if args.save_json:
        saved_json = save_results_json(
            results,
            make_data_output_path("compare_griewank.json", args.output_dir),
            metadata={
                "problem": "Griewank",
