...
def main() -> None:
    parser = argparse.ArgumentParser(description="Algorithm comparison on Rastrigin (2-D)")
    ...
    save_path = make_output_path("compare_rastrigin.png", args.output_dir) if args.save else None
