...
from AIP.problems import Sphere, Rastrigin, Ackley, Griewank, Rosenbrock
from AIP.algorithm import (
    GeneticAlgorithm,
    GAParameter,
    SelectionMethod,
    CrossoverMethod,
...
def run_grid_search(
    ...
    print(f"\n{'=' * 65}")
    print(f"  Grid Search for {target_algo}  |  {total} configs x {n_runs} runs")
...
def main():
    ...
    fa_config = FireflyParameter(n_fireflies=25,alpha=0.25,beta0=0.001,gamma=1,alpha_decay=0.98,iteration=args.cycle)
